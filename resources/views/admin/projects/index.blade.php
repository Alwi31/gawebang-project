        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @forelse ($projects as $project)
                    <div class="item-card flex flex-col md:flex-row items-center gap-6 p-5 border rounded-2xl">
                        ...
                        <div class="hidden md:flex flex-col">
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold text-center">
                ...
                @empty
                    <p class="text-center text-slate-500">Belum ada data project terbaru.</p>
                @endforelse
