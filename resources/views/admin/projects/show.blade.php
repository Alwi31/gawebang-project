            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                @forelse ($project->applicants as $applicant)
                    <div class="flex flex-row justify-between items-center">
                        <div class="flex flex-row items-center gap-x-3">
                            ...
                            <div class="flex flex-col">
                                <h3 class="text-indigo-950 text-xl font-bold">{{ $applicant->freelancer->name }}
                                </h3>
                        ...
                        <div class="flex flex-row items-center gap-x-3">
                            <a href="{{ route('admin.project_applicants.show', $applicant) }}"
                                class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full" target="_blank">
                                Details
                            </a>
                        </div>
                    </div>
                @empty
                    <p class="text-slate-500 text-sm">
                        Belum ada applicant yang tertarik untuk project ini.
                    </p>
                @endforelse
