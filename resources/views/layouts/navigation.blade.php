    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('super_admin')
                ...
                <x-responsive-nav-link :href="route('admin.withdrawals')" :active="request()->routeIs('admin.withdrawals')">
                    {{ __('Withdrawals') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.topups')" :active="request()->routeIs('admin.topups')">
                    {{ __('Topups') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.tools.index')" :active="request()->routeIs('admin.tools.index')">
                    {{ __('Tools') }}
                </x-responsive-nav-link>
            @endrole
            ...
            @role('project_freelancer|project_client')
                <x-responsive-nav-link :href="route('dashboard.wallet')" :active="request()->routeIs('dashboard.wallet')">
                    {{ __('My Wallets') }}
                </x-responsive-nav-link>
            @endrole
            ...
            @can('apply job')
                <x-responsive-nav-link :href="route('dashboard.proposals')" :active="request()->routeIs('dashboard.proposals')">
                    {{ __('My Proposals') }}
                </x-responsive-nav-link>
            @endcan
        </div>
