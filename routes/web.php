...
// Akses yang dilindungi oleh middleware auth dan verified untuk mengakses dashboard (halaman dashboard) yaitu /dashboard yang akan menampilkan view dashboard.blade.php dengan nama route dashboard dan akan menampilkan halaman dashboard jika user sudah login dan email terverifikasi 
